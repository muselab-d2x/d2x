...
from d2x.auth.sf.login_url import main, parse_sfdx_auth_url, exchange_token
from d2x.auth.sf.models import TokenResponse, SalesforceOrgInfo

class TestLoginUrl(unittest.TestCase):

    @patch("d2x.auth.sf.login_url.parse_sfdx_auth_url")
    @patch("d2x.auth.sf.login_url.exchange_token")
    @patch("d2x.auth.sf.login_url.Console")
    ...
    @patch("d2x.auth.sf.login_url.http.client.HTTPSConnection")
